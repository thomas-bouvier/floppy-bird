...
#define DEATH_REWARD -20 /*!< Reward when the bird died */

#define LIFE_REWARD +4 /*!< Reward when the bird is alive */
...
#define NB_SAVED_ACTIONS 6 /*!< Number of saved actions to compute the new reward and to compute the velocity (must be >(NB_SAVED_STATES-1) and >4 actions) */
