...
#define LIFE_REWARD +15 /*!< Reward when the bird is alive */
...
#define NB_SAVED_STATES 360 /*!< Number of saved states to compute the new reward */

#define NB_SAVED_ACTIONS 359 /*!< Number of saved states to compute the new reward */

#define NB_FPS_BEFORE_NEXT_ACTION 12 /*!< Number of FPS between two actions */
