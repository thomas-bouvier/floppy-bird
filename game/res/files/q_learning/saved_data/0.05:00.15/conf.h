...
#define LEARNING_RATE 0.7 /*!< Changed the percentage of the result of the last action in the computation of the new reward */
...
#define NB_FPS_BEFORE_NEXT_ACTION 10 /*!< Number of FPS between two actions */
