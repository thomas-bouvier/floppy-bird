...
#define DEATH_REWARD -30 /*!< Reward when the bird died */
...
#define NB_SAVED_STATES 25 /*!< Number of saved states to compute the new reward */

#define NB_SAVED_ACTIONS 24 /*!< Number of saved states to compute the new reward */
