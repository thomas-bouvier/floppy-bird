...
#define DEATH_REWARD -1 /*!< Reward when the bird died */
...
#define DISTANCE_ACCURACY 20 /*!< Accuracy of the distance to process less states, an higher value reduce the accuracy and raise the collision risk */
