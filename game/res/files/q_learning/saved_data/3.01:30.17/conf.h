...
#define LEARNING_RATE 0.85 /*!< Changed the percentage of the result of the last action in the computation of the new reward */
#define DEATH_REWARD -4 /*!< Reward when the bird died */
...
#define NB_SAVED_STATES 4 /*!< Number of saved states to compute the new reward */

#define NB_SAVED_ACTIONS 3 /*!< Number of saved states to compute the new reward */
