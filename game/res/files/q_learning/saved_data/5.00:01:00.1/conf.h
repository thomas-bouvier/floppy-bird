...
#define DISCOUNT 0.7 /*!< Changed the weight of future rewards in the computation of the best action to make */

#define LEARNING_RATE 0.9 /*!< Changed the percentage of the result of the last action in the computation of the new reward */
#define DEATH_REWARD -1000 /*!< Reward when the bird died */

#define LIFE_REWARD +40 /*!< Reward when the bird is alive */
...
#define NB_SAVED_STATES 5 /*!< Number of saved states to compute the new reward */

#define NB_SAVED_ACTIONS 4 /*!< Number of saved states to compute the new reward */
